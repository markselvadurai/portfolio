...
export const ProjectsSection = () => {
  return (
    <section className="pb-16 lg:py-24" id="projects">
      <ShootingStars className="min-h-max -z-10 top-0" />
      <StarsBackground className="min-h-max -z-10 top-0"/>
      <div className="container pt-16 ">
        ...
        <div className="flex flex-col mt-10 gap-20">
          {portfolioProjects.map((project, index) => (
            <div className="sticky top-16  " key={project.title} style={{
              top: `calc(64px + ${index * 40}px`,
            }}>
            <BackgroundGradient >
              <Card className="px-8 pt-8 md:pt-12 md:px-10 lg:px-20 lg:pt-16 pb-0 project-card"
                >
